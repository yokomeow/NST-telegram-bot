...
Original file is located at
    https://colab.research.google.com/drive/1MfwU0KBKA-0TR-DFUSn7fLac2NutHro5
...
class ImageProcessing():
    ...
    def __init__(self, content_image_name, style_image_name):
        ...
        self.imsize = min(512, min(min(self.get_imsize(self.content_image_name)), min(self.get_imsize(self.style_image_name))))
...
class NST:
    ...
    def run_style_transfer(self, content_img_tensor, style_img_tensor, input_img_tensor,
                           num_steps=700, style_weight=10000000, content_weight=1):
